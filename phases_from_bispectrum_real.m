function [z,zcost,info, problem] = phases_from_bispectrum_real(B_weighted, sign_mean, z_init)
...
% https://github.com/ARKEYTECT/Bispectrum_Inversion
    ...
    options.verbosity = 0;
    [z, zcost,info] = trustregions(problem, z_init, options);
    ...
    if N/2 == round(N/2)
        ...
        if z2cost < zcost
            ...
            [z,cost,info] = trustregions(problem, z2, options);
        end
    end
